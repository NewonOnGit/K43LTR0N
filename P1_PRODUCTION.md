...
*Five structurally independent domains, one threshold number. All five are the Gibbs equilibrium of the two-channel computation at the framework's natural temperature β = ln(φ) (COMPUTATION §5).* ∎
